...
Location.create location: "Washington, DC"
Location.create location: "Arlington, VA"
Location.create location: "Alexandria, VA"
Location.create location: "Chevy Chase, MD"
Location.create location: "Bethesda, MD"
Location.create location: "Fairfax, VA"
Location.create location: "Rockville, MD"
...
JobSeeker.create objective: "UX Designer position that utilizes my design skills and enables me to make a positive contribution to the organization", current_pos: "UX Designer", grad_year: 1995, college: "JMU", degree: "BAFA", location_id: get_random_location
JobSeeker.create objective: "To secure a position with a well established organization with a stable environment that will lead to a lasting relationship in the field of Web Development", current_pos: "Web Developer", grad_year: 2012, college: "UVA", degree: "BSCSE", location_id: get_random_location
JobSeeker.create objective: "To obtain a position that will enable me to use my strong organizational skills, educational background, and ability to work well with people", current_pos: "Product Manager", grad_year: 2000, college: "GMU", degree: "MSCSE", location_id: get_random_location
JobSeeker.create objective: "Create integrated strategies to develop and expand existing data sets, software evolution, and media enhancement", current_pos: "Data Scientist", grad_year: 2011, college: "SFCC", degree: "AA", location_id: get_random_location
JobSeeker.create objective: "UX Designer position with a well established organization with a stable environment that will lead to a lasting relationship in the field of cool computer stuff", current_pos: "UX Designer", grad_year: 1992, college: "VA Tech", degree: "BAFA", location_id: get_random_location
JobSeeker.create objective: "To secure a position imagining Dragons", current_pos: "Web Developer", grad_year: 2010, college: "Penn State", degree: "BSEE", location_id: get_random_location
JobSeeker.create objective: "To obtain a position that will enable me to use my strong communication skills, expertise, and ability to chill out with people", current_pos: "Product Manager", grad_year: 2002, college: "Florida", degree: "MSCSE", location_id: get_random_location
JobSeeker.create objective: "Create integrated strategies to numb people with my ability to expand and contract space and time", current_pos: "Data Scientist", grad_year: 2009, college: "Alabama", degree: "MAFA", location_id: get_random_location
